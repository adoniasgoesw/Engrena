...
// Component for Products and Services icon
const ProductsServicesIcon = ({ className = "h-5 w-5 text-[#207880]" }) => (
...
const Settings = () => {
  ...
  const managementItems = [
    ...
    { title: "Produtos e Serviços", url: "/produtos-servicos", icon: ProductsServicesIcon },
